	...
	var Item = function (_Component) {
	  ...
	  _createClass(Item, [{
	    ...
	    value: function onMouseLeave(event) {
	      var _props2 = this.props,
	          sectionIndex = _props2.sectionIndex,
	    ...
	    value: function onMouseDown(event) {
	      var _props3 = this.props,
	          sectionIndex = _props3.sectionIndex,
	    ...
	    value: function onClick(event) {
	      var _props4 = this.props,
	          sectionIndex = _props4.sectionIndex,
	    ...
	    value: function render() {
	      var _props5 = this.props,
	          ...
	          renderItemData = _props5.renderItemData,
	          restProps = _objectWithoutProperties(_props5, ['item', 'renderItem', 'renderItemData']);
